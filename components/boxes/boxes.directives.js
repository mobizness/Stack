...
app.directive('showBox', ['Box', '$routeParams', 'Auth', '$pusher', '$location', '$mdBottomSheet', 'Zone', 'ZoneListing', '$cookies', 'showToast', 'showErrors', '$mdDialog', '$q', 'ClientDetails', '$timeout', '$rootScope', 'Report', 'menu', 'gettextCatalog', function(Box, $routeParams, Auth, $pusher, $location, $mdBottomSheet, Zone, ZoneListing, $cookies, showToast, showErrors, $mdDialog, $q, ClientDetails, $timeout, $rootScope, Report, menu, gettextCatalog) {
  ...
  var link = function(scope,attrs,element,controller) {
    ...
    var init = function() {
      ...
      Box.get({id: $routeParams.box_id, metadata: true, period: scope.period}).$promise.then(function(box) {
        scope.box = box;
...
app.directive('addBoxWizard', ['Box', 'DeviceType', '$routeParams', '$location', '$pusher', 'Auth', '$timeout', '$rootScope', 'showToast', 'showErrors', '$route', '$q', '$mdEditDialog', 'Zone', 'gettextCatalog', function(Box, DeviceType, $routeParams, $location, $pusher, Auth, $timeout, $rootScope, showToast, showErrors, $route, $q, $mdEditDialog, Zone, gettextCatalog) {
  ...
  var link = function( scope, element, attrs, controller ) {
    ...
    var getDeviceTypes = function() {
      DeviceType.get().$promise.then(function(results) {
