...
app.directive('splashDesignerForm', ['$compile', function($compile) {
  ...
  var link = function(scope,element,attrs) {
    ...
    var init = function() {
      switch(attrs.access) {
      case '1':
        leform = '<input type="password" class="design-input" placeholder="What\'s the password?"><br>' +
...
app.directive('splashDesigner', ['Location', 'SplashPage', 'SplashPageForm', '$routeParams', '$q', 'menu', 'designer', '$timeout', 'showToast', 'showErrors', '$rootScope', 'gettextCatalog', function(Location, SplashPage, SplashPageForm, $routeParams, $q, menu, designer, $timeout, showToast, showErrors, $rootScope, gettextCatalog) {
  ...
  var link = function(scope,element,attrs) {
    ...
    designer.preview = function() {
      ...
      //window.open('http://localhost/server/'+scope.splash.id+'?cmd=login&mac=FF-FF-FF-FF-FF-FF&apname=44-D9-E7-F2-64-11','winname&vcname=instant-C6:3C:E8','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1000');
      window.open('https://app.digifi.social/'+scope.splash.id+'?cmd=login&mac=FF-FF-FF-FF-FF-FF&apname=44-D9-E7-F2-64-11','winname&vcname=instant-C6:3C:E8','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1000');
