...
var app = angular.module('myApp.device_types.controller', []);

app.controller('DeviceTypesController', ['$rootScope', '$window', '$scope', '$routeParams', 'User', '$location', 'menu', '$cookies', 'gettextCatalog',
  function($rootScope, $window, $scope, $routeParams, User, $location, menu, $cookies, gettextCatalog) {
    ...
    menu.sectionName = 'DeviceType';

    menu.sections = [{
      name: gettextCatalog.getString('Details'),
      type: 'link',
      link: '/device-types/' + id,
      icon: 'face',
