...
app.directive('listForms', ['Form', 'FormListing', 'Location', '$routeParams', '$rootScope', 'showToast', 'showErrors', 'menu', '$mdDialog', 'gettextCatalog', function(Form, FormListing, Location, $routeParams, $rootScope, showToast, showErrors, menu, $mdDialog, gettextCatalog) {
  ...
  var link = function(scope,element,attrs) {
    ...
    scope.types = [
      ...
      {key: gettextCatalog.getString('Password'), value: 'password'},
      {key: gettextCatalog.getString('Text'), value: 'text'},
      {key: gettextCatalog.getString('Checkbox'), value: 'checkbox'},
      {key: gettextCatalog.getString('Text Area'), value: 'textarea'},
      //{key: gettextCatalog.getString('Radio'), value: 'radio'},
      //{key: gettextCatalog.getString('Dropdown'), value: 'dropdown' }
    ];
