...
app.config(['$routeProvider', '$locationProvider', '$httpProvider', '$mdThemingProvider', '$mdIconProvider', function ($routeProvider, $locationProvider, $httpProvider, $mdThemingProvider, $mdIconProvider) {
  ...
  $routeProvider.
    ...
    when('/device-types', {
      templateUrl: 'components/views/device_types/index.html',
      resolve: { loginRequired: loginRequired },
    }).
    when('/device-types/new', {
      templateUrl: 'components/views/device_types/new/index.html',
      resolve: { loginRequired: loginRequired }
    }).
    when('/device-types/:id', {
      controller: 'DeviceTypesController',
      templateUrl: 'components/views/device_types/show.html',
      resolve: { loginRequired: loginRequired },
